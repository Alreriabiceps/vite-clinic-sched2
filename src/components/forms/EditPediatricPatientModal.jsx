...
export default function EditPediatricPatientModal({ patient, isOpen, onClose, onSuccess }) {
          ...
          <CardHeader className="border-b sticky top-0 bg-white z-10 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-xl">Edit Pediatric Patient</CardTitle>
                  <CardDescription>Update the patient's information.</CardDescription>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-end gap-3 pt-6 mt-6 border-t">
                ...
                <Button type="submit" variant="clinic" disabled={isLoading}>
                  {isLoading ? <LoadingSpinner size="sm" className="mr-2" /> : 'Save Changes'}
                </Button>
              </div>
            </form>
          </CardContent>
