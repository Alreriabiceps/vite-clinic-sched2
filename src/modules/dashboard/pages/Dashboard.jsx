import { Card, CardContent, CardDescription, CardHeader, CardTitle, Button, reportsAPI, appointmentsAPI, patientsAPI, useAuth, LoadingSpinner } from '../../shared';
...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Section */}
      <div className="bg-gradient-to-r from-warm-pink to-muted-gold rounded-lg p-6 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-off-white border-soft-olive-200">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-charcoal">Today's Appointments</CardTitle>
            <Calendar className="h-4 w-4 text-muted-gold" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-warm-pink">{dashboardData.todayAppointments}</div>
        ...
        <Card className="bg-off-white border-soft-olive-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-warm-pink">{dashboardData.totalPatients.toLocaleString()}</div>
            <p className="text-xs text-muted-gold">
              Registered patients
            </p>
          </CardContent>
        ...
        <Card className="bg-off-white border-soft-olive-200">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-charcoal">Pending Appointments</CardTitle>
            <FileText className="h-4 w-4 text-muted-gold" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-warm-pink">{dashboardData.pendingReports}</div>
            <p className="text-xs text-muted-gold">
              Need confirmation
            </p>
          </CardContent>
        ...
        <Card className="bg-off-white border-soft-olive-200">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-charcoal">Next Appointment</CardTitle>
              ...
              dashboardData.recentActivities.map((activity, index) => (
                <div key={index} className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-gold">{activity.details}</p>
                  </div>
                </div>
              ))
            ) : (
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-light-blush p-4 rounded-lg border border-warm-pink-200">
              <h3 className="font-semibold text-charcoal mb-2">Dr. Maria Sarah L. Manaloto</h3>
              <p className="text-sm text-muted-gold mb-3">OB-GYNE Specialist</p>
              <div className="space-y-1 text-sm text-charcoal">
                <div className="flex justify-between">
                  <span>Monday:</span>
                  <span className="text-warm-pink font-medium">8:00 AM - 12:00 PM</span>
                </div>
                <div className="flex justify-between">
                  <span>Wednesday:</span>
                  <span className="text-warm-pink font-medium">9:00 AM - 2:00 PM</span>
                </div>
                <div className="flex justify-between">
                  <span>Friday:</span>
                  <span className="text-warm-pink font-medium">1:00 PM - 5:00 PM</span>
                </div>
              </div>
            </div>

            <div className="bg-soft-olive-100 p-4 rounded-lg border border-soft-olive-300">
              <h3 className="font-semibold text-charcoal mb-2">Dr. Shara Laine S. Vino</h3>
              <p className="text-sm text-muted-gold mb-3">Pediatrician</p>
              <div className="space-y-1 text-sm text-charcoal">
                <div className="flex justify-between">
                  <span>Monday:</span>
                  <span className="text-muted-gold-700 font-medium">1:00 PM - 5:00 PM</span>
                </div>
                <div className="flex justify-between">
                  <span>Tuesday:</span>
                  <span className="text-muted-gold-700 font-medium">1:00 PM - 5:00 PM</span>
                ...
                <div className="flex justify-between">
                  <span>Thursday:</span>
                  <span className="text-muted-gold-700 font-medium">8:00 AM - 12:00 PM</span>
                </div>
              </div>
            </div>
          </div>
