...
const AddConsultationModal = ({ patientId, patientType, onClose, onSuccess }) => {
  ...
  const renderPediatricForm = () => (
    <div className="space-y-4">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Nature of Transaction</label>
        <textarea 
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Impression/Diagnosis</label>
        <textarea 
